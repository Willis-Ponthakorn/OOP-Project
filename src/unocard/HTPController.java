 ...
 * @author User
 */
public class HTPController implements Initializable {
    ...
    @FXML
    private void handlnextPage(ActionEvent event) throws IOException {
        Parent HowToPlay2 = FXMLLoader.load(getClass().getResource("HTP1.fxml"));
